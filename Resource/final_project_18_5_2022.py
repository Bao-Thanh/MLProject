...
def set_processed_train_set(full_pipeline, processed_train_set_val):
    onehot_cols = []
...
def load_model(model_name):
    ...
    #print(model)
    return model
def fit_transform_and_dump_set(train_set, full_pipeline):
...
def print_features_and_importance_score(best_model,full_pipeline,cat_feat_names):
...
def fit_train_set(search,processed_train_set_val,train_set_labels):
...
# Convert JSON to one hot dataframe and temp
    ...
    data_set = pd.concat([df,df_Genre_list],axis=1)
...
# %%
def train_and_dump_model(num_feat_names, cat_feat_names, onehot_feat_names, test_set):
    ...
    processed_train_set_val = fit_transform_and_dump_set(train_set, full_pipeline)
...
# 
    print_features_and_importance_score(best_model,full_pipeline,cat_feat_names)

#  Try to fit train set
    model = fit_train_set(search,processed_train_set_val,train_set_labels)
...
best_model, processed_test_set = train_and_dump_model(num_feat_names, cat_feat_names, onehot_feat_names, test_set)
# %%
